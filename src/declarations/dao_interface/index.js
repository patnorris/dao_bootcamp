...
import { idlFactory } from './dao_interface.did.js';
export { idlFactory } from './dao_interface.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAO_INTERFACE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dao_interface.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dao_interface canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dao_interface.did.js")._SERVICE>}
 */
export const dao_interface = createActor(canisterId);
