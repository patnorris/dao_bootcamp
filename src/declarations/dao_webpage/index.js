...
import { idlFactory } from './dao_webpage.did.js';
export { idlFactory } from './dao_webpage.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAO_WEBPAGE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dao_webpage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dao_webpage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dao_webpage.did.js")._SERVICE>}
 */
export const dao_webpage = createActor(canisterId);
